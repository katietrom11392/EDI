...
public:
    ...
    QPushButton *pushButton_deleteShift;
    QPushButton *pushButton_insertShift;
    ...
    void setupUi(QWidget *ControlTab_ViewEditEmployee)
    {
        ...
        timeEdit_Start = new QTimeEdit(ControlTab_ViewEditEmployee);
        timeEdit_Start->setObjectName(QString::fromUtf8("timeEdit_Start"));
        timeEdit_Start->setEnabled(false);
        timeEdit_Start->setGeometry(QRect(472, 248, 81, 22));
        timeEdit_End = new QTimeEdit(ControlTab_ViewEditEmployee);
        timeEdit_End->setObjectName(QString::fromUtf8("timeEdit_End"));
        timeEdit_End->setEnabled(false);
        timeEdit_End->setGeometry(QRect(472, 270, 81, 22));
        ...
        pushButton_saveChanges->setGeometry(QRect(350, 10, 131, 32));
        pushButton_deleteShift = new QPushButton(ControlTab_ViewEditEmployee);
        pushButton_deleteShift->setObjectName(QString::fromUtf8("pushButton_deleteShift"));
        pushButton_deleteShift->setEnabled(false);
        pushButton_deleteShift->setGeometry(QRect(260, 267, 112, 32));
        pushButton_insertShift = new QPushButton(ControlTab_ViewEditEmployee);
        pushButton_insertShift->setObjectName(QString::fromUtf8("pushButton_insertShift"));
        pushButton_insertShift->setEnabled(false);
        pushButton_insertShift->setGeometry(QRect(260, 242, 111, 32));
        ...
        pushButton_restoreDefault->setGeometry(QRect(10, 10, 131, 32));
        ...
        QWidget::setTabOrder(calendarWidget, timeEdit_Start);
        QWidget::setTabOrder(timeEdit_Start, timeEdit_End);
        QWidget::setTabOrder(timeEdit_End, pushButton_insertShift);
        QWidget::setTabOrder(pushButton_insertShift, pushButton_deleteShift);
        QWidget::setTabOrder(pushButton_deleteShift, pushButton_editMode);
    ...
    void retranslateUi(QWidget *ControlTab_ViewEditEmployee)
    {
        ...
        pushButton_deleteShift->setText(QCoreApplication::translate("ControlTab_ViewEditEmployee", "Delete Shift", nullptr));
        pushButton_insertShift->setText(QCoreApplication::translate("ControlTab_ViewEditEmployee", "Insert Shift", nullptr));

...
"border-radius: 15px;"));
        ...
        comboBox = new QComboBox(tab_analyze_2);
        comboBox->setObjectName(QString::fromUtf8("comboBox"));
        comboBox->setGeometry(QRect(330, 530, 69, 22));
        lastWeek = new QRadioButton(tab_analyze_2);
        lastWeek->setObjectName(QString::fromUtf8("lastWeek"));
        lastWeek->setGeometry(QRect(740, 530, 82, 17));
        ...
        labelEDI->setGeometry(QRect(90, 20, 231, 16));
